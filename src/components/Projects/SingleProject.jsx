...
const SingleProject = ({ imgPath, title, desc, liveLink, client, server, feature1, feature2, feature3, tech }) => {
   return (
      <div data-aos="zoom-in" data-aos-delay="400" data-aos-anchor-placement="top-center" className="max-w-[420px] w-full p-2 border rounded-md relative pb-12 group">
         ...
         <p className='absolute text-3xl uppercase top-12 right-6 font-bold opacity-30 group-hover:opacity-0 duration-700'>hover me</p>
      </div>
   );
};
